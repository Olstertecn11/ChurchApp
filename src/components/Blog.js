            ...
            <div className="container">
                <div className="row">
                    <div className="col text-center">
                        ...
                        <p className="text-muted text-center">Movimiento adventista luchando para alcanzar almas</p> 
                        <button className="btn btn-warning text-left" >Conocer Más</button>
                    </div>
                    <div className="col">
                        <img className="s_img" src="https://cdn.pixabay.com/photo/2017/03/02/05/14/bible-2110439__340.jpg" width="500" alt="" />
                    </div>
                </div>
            </div>
        </div>
